...
void m5stackDisplay_MinerScreen(unsigned long mElapsed)
{
  ...
  // Check capacitive buttons for screen navigation
  M5.update();
  ...
  M5.Lcd.drawString("[A]Prev", 10, 225);
  M5.Lcd.drawString("[C]Next", 270, 225);
}
...
void m5stackDisplay_ClockScreen(unsigned long mElapsed)
{
  ...
  M5.Lcd.setTextFont(1);
  M5.Lcd.setTextColor(TFT_DARKGREY);
  M5.Lcd.drawString("Shares: " + data.completedShares, 160, 210);
  M5.Lcd.drawString("[A]Prev", 10, 225);
  M5.Lcd.drawString("[C]Next", 270, 225);
}
...
void m5stackDisplay_GlobalHashScreen(unsigned long mElapsed)
{
  ...
  M5.Lcd.drawLine(0, 165, 320, 165, TFT_DARKGREY);
  M5.Lcd.setTextFont(1);
  M5.Lcd.setTextColor(TFT_GREENYELLOW);
  M5.Lcd.drawString("Next Halving Progress:", 10, 173);
  ...
  M5.Lcd.drawString(data.remainingBlocks, 160, 188);
  
  // Button hints
  M5.Lcd.setTextDatum(TL_DATUM);
  M5.Lcd.setTextColor(TFT_DARKGREY);
  M5.Lcd.drawString("[A]Prev", 10, 215);
  M5.Lcd.drawString("[C]Next", 270, 215);
}
