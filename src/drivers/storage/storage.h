...
// default settings
#ifndef HAN
#define DEFAULT_SSID		"M8AX-Minero"
#else
#define DEFAULT_SSID		"HanSoloAP"
#endif
#define DEFAULT_WIFIPW		"MinaTuPasta"
#define DEFAULT_POOLURL		"public-pool.io"
#define DEFAULT_POOLPASS	"x"
#define DEFAULT_WALLETID	"Tu Billetera De Bitcoin"
#define DEFAULT_BOTTELEGRAM	"NO CONFIGURADO"
#define DEFAULT_CHANELID	"NO CONFIGURADO"
...
#define JSON_KEY_BOTTELEGRAM "botTelegram"
#define JSON_KEY_CHANELID	"chanelIDTelegram"
...
#define JSON_SPIFFS_KEY_BOTTELEGRAM	"botTelegram"
#define JSON_SPIFFS_KEY_CHANELID	"chanelIDTelegram"
...
struct TSettings
{
	...
	char botTelegram[80]{ DEFAULT_BOTTELEGRAM };
	char ChanelIDTelegram[80]{ DEFAULT_CHANELID };
