...
static constexpr uint32_t kI2cInvalidNonce = 0xFFFFFFFFu;
static constexpr uint8_t kI2cNoJobId = 0xFFu;
...
static inline uint8_t i2cCommandCrc8(const void *data, size_t len)
{
